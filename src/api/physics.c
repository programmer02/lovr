...
static int l_lovrPhysicsNewWorld(lua_State* L) {
  f32 xg = luax_optf32(L, 1, 0.f);
  f32 yg = luax_optf32(L, 2, -9.81f);
  f32 zg = luax_optf32(L, 3, 0.f);
...
static int l_lovrPhysicsNewBoxShape(lua_State* L) {
  f32 x = luax_optf32(L, 1, 1.f);
  f32 y = luax_optf32(L, 2, x);
  f32 z = luax_optf32(L, 3, x);
...
static int l_lovrPhysicsNewCapsuleShape(lua_State* L) {
  f32 radius = luax_optf32(L, 1, 1.f);
  f32 length = luax_optf32(L, 2, 1.f);
...
static int l_lovrPhysicsNewDistanceJoint(lua_State* L) {
  Collider* a = luax_checktype(L, 1, Collider);
  Collider* b = luax_checktype(L, 2, Collider);
  f32 x1 = luax_checkf32(L, 3);
  f32 y1 = luax_checkf32(L, 4);
  f32 z1 = luax_checkf32(L, 5);
  f32 x2 = luax_checkf32(L, 6);
  f32 y2 = luax_checkf32(L, 7);
  f32 z2 = luax_checkf32(L, 8);
...
static int l_lovrPhysicsNewSliderJoint(lua_State* L) {
  Collider* a = luax_checktype(L, 1, Collider);
  Collider* b = luax_checktype(L, 2, Collider);
  f32 ax = luax_checkf32(L, 3);
  f32 ay = luax_checkf32(L, 4);
  f32 az = luax_checkf32(L, 5);
